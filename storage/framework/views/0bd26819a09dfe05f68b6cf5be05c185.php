<?php $__env->startSection('title', 'Ejercicios MVC Laravel'); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <div class="card">
        ...
        <a href="<?php echo e(route('exercise1.index')); ?>" class="btn">Ver solución</a>
    </div>
    ...
    <div class="card">
        ...
        <a href="<?php echo e(route('exercise2.index')); ?>" class="btn">Ver solución</a>
    </div>
    ...
    <div class="card">
        ...
        <a href="<?php echo e(route('exercise3.index')); ?>" class="btn">Ver solución</a>
    </div>
    ...
    <div class="card">
        ...
        <a href="<?php echo e(route('exercise4.index')); ?>" class="btn">Ver solución</a>
    </div>
    ...
    <div class="card">
        ...
        <a href="<?php echo e(route('exercise5.index')); ?>" class="btn">Ver solución</a>
    </div>
    ...
    <div class="card">
        ...
        <a href="<?php echo e(route('exercise6.index')); ?>" class="btn">Ver solución</a>
    </div>
    ...
    <div class="card">
        ...
        <a href="<?php echo e(route('exercise7.index')); ?>" class="btn">Ver solución</a>
    </div>
    ...
    <div class="card">
        ...
        <a href="<?php echo e(route('exercise8.index')); ?>" class="btn">Ver solución</a>
    </div>
    ...
    <div class="card">
        ...
        <a href="<?php echo e(route('exercise9.index')); ?>" class="btn">Ver solución</a>
    </div>
    ...
    <div class="card">
        ...
        <a href="<?php echo e(route('exercise10.index')); ?>" class="btn">Ver solución</a>
    </div>
    ...
    <div class="card">
        ...
        <a href="<?php echo e(route('exercise11.index')); ?>" class="btn">Ver solución</a>
    </div>
<?php $__env->stopSection(); ?>


<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/kevinvilla/Downloads/trabajo/ejercicios-mvc-laravel/resources/views/home.blade.php ENDPATH**/ ?>